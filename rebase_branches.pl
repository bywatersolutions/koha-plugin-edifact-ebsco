...
say "\nNot koha-plugin-edifact-ebsco, exiting" && exit 0 unless $repo eq "koha-plugin-edifact-ebsco";
...
foreach my $repo (@repos) {
    next if $repo eq 'koha-plugin-edifact-ebsco';
    next if $repo eq 'koha-plugin-edifact-ebsco-docs';
